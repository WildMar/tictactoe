...
play_fields = game_ns.model("Game", {
    ...
    "row2": fields.List(fields.String, description="Second row of board", required=True),
    "row3": fields.List(fields.String, description="Third row of board", required=True),
...
class Game(Resource):
    ...
    def post(self):
        ...
        print(new_board)
        return dict(board=new_board, game_status=game_status)
